...
while True:
    ...
    if num_disks >= 3:
        ...
        print('Please choose a number of disks greater than or equal to 3.')
        continue

for disk in range(num_disks, 0, -1):
    left_stack.push(disk)

optimal_moves = 2 ** left_stack.size - 1
print('\nThe minimum number of moves to solve this game is {}'.format(optimal_moves))
